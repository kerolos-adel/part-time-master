                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: <Widget>[
                                            addRadioButton(0, SettingsCubit.get(context).currentLanguage["male"]),
                                            addRadioButton(1, SettingsCubit.get(context).currentLanguage["female"]),
                                            addRadioButton(2, SettingsCubit.get(context).currentLanguage["other"]),
                                          ],
                                        ),
                                        Divider(
                                          thickness: 1,
